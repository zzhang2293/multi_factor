...
class factorModel:
    ...
    def getData(self):
        ...
        def transform_data(all_period_data:dict, factor_name_lst:list):
            ...
            return analysis_3D_list_label, analysis_2D_monthly_return, all_period_data[0].index.tolist()
        ...
        def run():
            ...
            factor_3D, month_profit, stock_list = transform_data(all_period_data, self.factor_name_lst)

            factor_MAP = {}
            '''
                factor_MAP = {'000001.SZ': list[list[float]]}
                    - dim 1 = time
                    - dim 2 = score
            '''
    ...
    def run(self):
        ...
        # #Step 5: Track Return #TODO -> Parallelize
